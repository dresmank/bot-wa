...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:DARK BOT\n'
            + 'ORG:Owner Gans;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6285339002283:+62 853-3900-2283\n'
            + 'END:VCARD'
...
premium = ["6285339002283@s.whatsapp.net"]
...
async function starts() {
	...
	dms.on('chat-update', async (mek) => {
		try {
			...
			const BotWea2 = ["085339002283@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["6285339002283@s.whatsapp.net"] // owner number ubah aja
		...
		case prefix+'daftar':
         ...
         case prefix+'lirik':
                ...
                //if (!isPublic) return reply(mess.only.publikG)
                    ...
                    dms.sendMessage('6285339002283@s.whatsapp.net', options, text, {quoted: mek})
